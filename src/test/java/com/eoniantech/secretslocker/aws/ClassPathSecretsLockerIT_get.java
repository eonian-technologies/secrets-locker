 ...
 * @since 1.0
 */
public class ClassPathSecretsLockerIT_get extends AbstractTest {
    ...
    @Test
    public void testGet() {
        assertEquals(SECRET_FILE_CONTENTS, secretsLocker.get("MySecret"));
    }

    @Test(expected = SecretsLockerException.class)
    public void testGet_doesNotExist() {
        assertNull(secretsLocker.get("DoesNotExist"));
    }
